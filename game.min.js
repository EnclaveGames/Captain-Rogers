...
this.sound.play();window.open('http://www.facebook.com/CaptainRogersChronicles');}}});EntityButtonBack=EntityButton.extend({size:{x:206,y:58},animSheet:new ig.AnimationSheet('media/img/button-back.png',206,58),update:function(){if(ig.input.pressed('click')&&this.inFocus()){if(ig.Sound.enabled)

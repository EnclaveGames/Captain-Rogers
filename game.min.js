...
checkOrientation=function(){if(ig.ua.mobile&&(window.orientation==0||window.orientation==180)){document.getElementById('portrait').style.display='block';document.getElementById('portrait').innerHTML='<img src="media/img/screen-rotate.png" />';document.getElementById('game').style.display='none';}
else{document.getElementById('portrait').style.display='none';document.getElementById('portrait').innerHTML='';document.getElementById('game').style.display='block';}}
if(ig.ua.mobile&&(window.orientation==0||window.orientation==180)){document.getElementById('portrait').style.display='block';document.getElementById('portrait').innerHTML='<img src="media/img/screen-rotate.png" />';document.getElementById('game').style.display='none';}

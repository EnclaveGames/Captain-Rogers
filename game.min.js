...
var _LANG_SIZES={'en':{'shield':{x:100,y:20},'score':{x:150,y:20}},'en-US':{'shield':{x:100,y:20},'score':{x:150,y:20}},'es':{'shield':{x:105,y:20},'score':{x:168,y:20}},'pt':{'shield':{x:105,y:20},'score':{x:170,y:20}},'tr':{'shield':{x:102,y:20},'score':{x:143,y:20}},'cs':{'shield':{x:92,y:20},'score':{x:150,y:20}},'ja':{'shield':{x:83,y:20},'score':{x:146,y:20}}};getOrRefreshLanguage();
...
this.sound.play();window.top.location.href='http://blackmoondev.com';}}});EntityButtonStart=EntityButton.extend({size:{x:181,y:60},animSheet:new ig.AnimationSheet('media/img/'+_LANG_STRING+'button-start.png',181,60),update:function(){if(ig.input.pressed('click')&&this.inFocus()){if(ig.Sound.enabled){this.sound.play();}
...
this.sound.play();window.top.location.href='https://www.facebook.com/CaptainRogersChronicles';}}});EntityButtonBack=EntityButton.extend({size:{x:186,y:58},animSheet:new ig.AnimationSheet('media/img/'+_LANG_STRING+'button-back.png',186,58),update:function(){if(ig.input.pressed('click')&&this.inFocus()){if(ig.Sound.enabled)
this.sound.play();ig.system.setGame(StartScreen);}}});EntityButtonContinue=EntityButton.extend({size:{x:132,y:43},animSheet:new ig.AnimationSheet('media/img/'+_LANG_STRING+'button-continue.png',132,43),update:function(){if(ig.input.pressed('click')&&this.inFocus()){if(ig.Sound.enabled)
this.sound.play();}}});EntityButtonRestart=EntityButton.extend({size:{x:186,y:58},animSheet:new ig.AnimationSheet('media/img/'+_LANG_STRING+'button-restart.png',186,58),update:function(){if(ig.input.pressed('click')&&this.inFocus()){if(ig.Sound.enabled)

...
this.sound.play();window.top.location.href='http://blackmoondev.com';}}});EntityButtonStart=EntityButton.extend({size:{x:183,y:60},animSheet:new ig.AnimationSheet('media/img/button-start.png',183,60),update:function(){if(ig.input.pressed('click')&&this.inFocus()){if(ig.Sound.enabled){this.sound.play();}
...
this.sound.play();window.top.location.href='https://www.facebook.com/CaptainRogersChronicles';}}});EntityButtonBack=EntityButton.extend({size:{x:206,y:58},animSheet:new ig.AnimationSheet('media/img/button-back.png',206,58),update:function(){if(ig.input.pressed('click')&&this.inFocus()){if(ig.Sound.enabled)
this.sound.play();ig.system.setGame(StartScreen);}}});EntityButtonContinue=EntityButton.extend({size:{x:146,y:43},animSheet:new ig.AnimationSheet('media/img/button-continue.png',146,43),update:function(){if(ig.input.pressed('click')&&this.inFocus()){if(ig.Sound.enabled)
this.sound.play();}}});EntityButtonRestart=EntityButton.extend({size:{x:197,y:58},animSheet:new ig.AnimationSheet('media/img/button-restart.png',197,58),update:function(){if(ig.input.pressed('click')&&this.inFocus()){if(ig.Sound.enabled)

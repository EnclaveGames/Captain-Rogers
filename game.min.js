...
this.BtnRestart=this.spawnEntity(EntityButtonRestart,10,ig.system.height-58-10);if(!this.BtnBack)
this.BtnBack=this.spawnEntity(EntityButtonBack,ig.system.width-206-10,ig.system.height-58-10);this.BtnRestart.update();this.BtnBack.update();this.BtnAudio.update();}
...
else{this.BtnAudio.currentAnim=this.BtnAudio.anims['false'];}},update:function(){if(ig.input.pressed('start')){ig.system.setGame(StoryScreen);}
else if(ig.input.pressed('howTo')){ig.system.setGame(HowToScreen);}
this.counter++;this.parallax.move(40);this.parent();},draw:function(){this.parent();this.parallax.draw();this.BtnStart.draw();this.logoBlackmoon.draw(10,10);this.logoEnclave.draw(55,10);this.BtnFacebook.draw();this.BtnAudio.draw();var range=((this.counter/3)%60)-30;var delta=(range>0)?1:-1;var tick=range*delta;this.ship.draw(-30,ig.system.height-this.ship.height+tick+10);this.logo.draw((ig.system.width-this.logo.width)/2-20,10);this.title.draw((ig.system.width-this.title.width+160)/2,100);}});StoryScreen=ig.Game.extend({story:new ig.Image('media/img/screen-story.png'),buttonContinue:new ig.Image('media/img/button-continue.png'),init:function(){ig.input.bind(ig.KEY.SPACE,'start');ig.input.bind(ig.KEY.ENTER,'start');ig.input.bind(ig.KEY.MOUSE1,'start');},update:function(){if(ig.input.pressed('start')){ig.system.setGame(HowToScreen);}
